...
// modifications: pjunod
// project: Obfuscator
// library: LLVMobfuscator.so
// option : -boguscf
//
//===----------------------------------------------------------------------------------===//
...
namespace {
    struct BogusControlFlow : public FunctionPass {
        ...
        virtual bool runOnFunction(Function &F){
            ...
            if((FunctionName.size() != 0 && FunctionName.find(F.getName()) != string::npos) || ((int)llvm::cprng->get_range(100)) < Percentage) {
                ...
                do{
                    ...
                    while(!basicBlocks.empty()){
                        ...
                        if((int)llvm::cprng->get_range(100) <= ObfProbRate){
                ...
                if(i->isBinaryOp()){ // binary instructions
                    ...
                    if(opcode == Instruction::Add || opcode == Instruction::Sub ||
                       ...
                       opcode == Instruction::Xor){
                        for(int random = (int)llvm::cprng->get_range(10); random < 10; ++random){
                            switch(llvm::cprng->get_range(4)){ // to improve
                                case 0: //do nothing
                                    break;
                    ...
                    if(opcode == Instruction::FAdd || opcode == Instruction::FSub ||
                       ...
                       opcode == Instruction::FRem){
                        for(int random = (int)llvm::cprng->get_range(10); random < 10; ++random){
                            switch(llvm::cprng->get_range(3)){ // can be improved
                                case 0: //do nothing
                                    break;
                    ...
                    if(opcode == Instruction::ICmp){ // Condition (with int)
                        ...
                        switch(llvm::cprng->get_range(3)){ // must be improved
                            case 0: //do nothing
                                break;
                            case 1: currentI->swapOperands();
                                break;
                            case 2: // randomly change the predicate
                                switch(llvm::cprng->get_range(10)){
