...
typedef llvm::ImmutableMap<SymbolRef, SymbolRef> FreeReturnValueTy;
class RegionState {};
class ReallocPairs {};
class FreeReturnValue {};
namespace clang {
namespace ento {
  template <>
  ...
  // the free function.
  template <>
  struct ProgramStateTrait<FreeReturnValue>
    : public ProgramStatePartialTrait<FreeReturnValueTy> {
    static void *GDMIndex() { static int x; return &x; }
  };
}
}
